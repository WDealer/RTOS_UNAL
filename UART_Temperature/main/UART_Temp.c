...
void uart_read_task(void *arg)
{
    ...
    while(1)
    {
        ...
        if(len > 0)
        {
            ...
            else if(strncmp((const char *)data, "temp", 4) == 0)
            {
                current_state = TEMP;
            }
...
void app_main()
{
    ...
    xTaskCreate(uart_status_task, "uart_status_task", 2048, NULL, 10, NULL);
}
